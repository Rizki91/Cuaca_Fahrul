...
public class Cuacaone implements Serializable, Parcelable
{
    ...
    @Expose
    private City city;
    public final static Creator<Cuacaone> CREATOR = new Creator<Cuacaone>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Cuacaone createFromParcel(Parcel in) {
            return new Cuacaone(in);
        }

        public Cuacaone[] newArray(int size) {
            return (new Cuacaone[size]);
        }
     ...
     * @param list
     */
    public Cuacaone(String cod, Integer message, Integer cnt, java.util.List<List> list, City city) {
        super();
        this.cod = cod;
